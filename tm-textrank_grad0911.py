...
#### 9.2 textrank + term frequency, term postion, word co-occurence + Infomap + Multi Entropy + GloVe 
...
print(df_result92) #### 9.2 textrank + term frequency, term postion, word co-occurence + Infomap + Multi Entropy + GloVe 
...
# 평균 결과를 사전으로 변환
means_dict = {
    "1.1 textrank"  : means_result11,
"1.2 textrank + term frequency, term postion, word co-occurence"  : means_result12,
"1.3 textrank + term frequency, term postion, word co-occurence + Double Negation, Mitigation, and Hedges Weighting "  : means_result13,
"1.4 textrank + term frequency, term postion, word co-occurence + Double Negation, Mitigation, and Hedges Weighting + Glove"  : means_result14,
"2. textrank + TP-CoGlo-TextRank(GLove)"  : means_result2,
"3. textrank + Watts-Strogatz model"  : means_result3,
"4.1 textrank + Infomap"  : means_result41,
"4.2 textrank + term frequency, term postion, word co-occurence + Infomap"  : means_result42,
"4.3 textrank + Infomap + term frequency, term postion, word co-occurence + Double Negation, Mitigation, and Hedges"  : means_result43,
"5.1 textrank + Infomap + GloVe "  : means_result51,
"5.2 textrank + term frequency, term postion, word co-occurence + Infomap + GloVe"  : means_result52,
"5.3 textrank + term frequency, term postion, word co-occurence + Infomap + Double Negation, Mitigation, and Hedges + GloVe"  : means_result53,
"6.1 textrank + Infomap + Hierarchical"  : means_result61,
"6.2 textrank + term frequency, term postion, word co-occurence + Infomap + Hierarchical"  : means_result62,
"6.3 textrank + term frequency, term postion, word co-occurence + Double Negation, Mitigation, and Hedges Weighting + Infomap + Hierarchical"  : means_result63,
"7.1 textrank + Infomap + Hierarchical + GloVe "  : means_result71,
"7.2 textrank + term frequency, term postion, word co-occurence + Infomap + Hierarchical + GloVe "  : means_result72,
"7.3 textrank + term frequency, term postion, word co-occurence + Double Negation, Mitigation, and Hedges Weighting + Infomap + Hierarchical + GloVe "  : means_result73,
"8.1 textrank + Infomap + Multi Entropy"  : means_result81,
"8.2 textrank + term frequency, term postion, word co-occurence + Infomap + Multi Entropy"  : means_result82,
"8.3 textrank + term frequency, term postion, word co-occurence + Double Negation, Mitigation, and Hedges Weighting + Infomap + Multi Entropy"  : means_result83,
"9.1 textrank + Infomap + Multi Entropy + GloVe "  : means_result91,
"9.2 textrank + term frequency, term postion, word co-occurence + Infomap + Multi Entropy + GloVe "  : means_result92,
"9.3 textrank + term frequency, term postion, word co-occurence + Double Negation, Mitigation, and Hedges Weighting + Infomap + Multi Entropy + GloVe "  : means_result101,
"10.1 textrank + Infomap + jcd"  : means_result102,
"10.2 textrank + term frequency, term postion, word co-occurence + Infomap + jcd"  : means_result103,
"10.3 textrank + term frequency, term postion, word co-occurence + Double Negation, Mitigation, and Hedges Weighting + Infomap + jcd"  : means_result111,
"11.1 textrank + Infomap + NetMRF"  : means_result112,
"11.2 textrank + term frequency, term postion, word co-occurence + Infomap + NetMRF"  : means_result113,
"11.3 textrank + term frequency, term postion, word co-occurence + Double Negation, Mitigation, and Hedges Weighting + Infomap + NetMRF"  : means_result121,
"12.1 textrank + Infomap + NetMRF + GloVe "  : means_result122,
"12.2 textrank + term frequency, term postion, word co-occurence + Infomap + NetMRF + GloVe "  : means_result123
}
